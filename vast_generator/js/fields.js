$(document).ready(function(){
	...
	$('#notify').click(function(){
		...
		if (site == '' || letter == '') {
			...
			$('#vastTag').focus().val('http://www.burstnet.com/burstmedia/display/s=' + site +'/a=' + letter + '/v=4.0S/sz=' + size + '/NZ/SA/' + Math.floor(Math.random() * 9999999999 + 1) + '/K=videopair/ORG_URL=<referer url>/vid=<video id>/vtitle=<URL-encoded video title>/vdesc=<URL-encoded video description>/RETURN-CODE/TXT/').select();
		}
	});
});