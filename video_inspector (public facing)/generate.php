<?php
    ...
    $filepath= 'vast/videotest_'.$random.'.html';
    ...
    if ($player == 'embed'){
        $middlecontent = '
            ...
            document.write(\'<scr\'+\'ipt type=\"text/javascript\" src=\"http://bvp.burstmedia.com/player.js\"></scr\'+\'ipt>\');
            </script>
        ...
        $slidercontent = '
            ...
            document.write(\'<scr\'+\'ipt type="text/javascript" src="http://static-cdn.labs.burstnet.com/ads/js/burst.labs.videoslider.js"></scr\'+\'ipt>\');            
            </script>
